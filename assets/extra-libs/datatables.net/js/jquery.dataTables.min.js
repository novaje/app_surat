...
function Z(a) {
        ...
        function Ca(a) {
            ...
            if (a) {
                ...
                !a.sEmptyTable && (d && "No data available in table" === b.sEmptyTable) && F(
                    a,
                    a,
                    "sZeroRecords",
                    "sEmptyTable"
                );
                !a.sLoadingRecords && (d && "Loading..." === b.sLoadingRecords) && F(
                    a,
                    a,
                    "sZeroRecords",
                    "sLoadingRecords"
        ...
        function hb(a) {
            if (!n.__browser) {
                ...
                var c = h("<div/>")
                        ...
                        .append(
                            h("<div/>").css({position: "absolute", top: 1, left: 1, width: 100, overflow: "scroll"}).append(h("<div/>").css({width: "100%", height: 10}))
                        )
                        .appendTo("body"),
                    d = c.children(),
                    e = d.children();
...
- 1 != d && c === k && a.splice(d, 1)
            ...
            var e = [],
                ...
                G = function (a) {
                    if (c === k || c === i) 
                        ...
                        j && j._bAttrSrc
                            ? (N(j.mData._)(d, m), t(j.mData.sort, a), t(j.mData.type, a), t(
                                j.mData.filter,
                                a
                            ))
                            : q
        ...
        function sa(a, b, c) {
            ...
            if (h.isPlainObject(g) && g.data) {
                f = g.data;
                var m = "function" === typeof f
                        ? f(b, a)
                        : f,
                    b = "function" === typeof f && m
                        ? m
                        : h.extend(!0, b, m);
                delete g.data
            }
        ...
        function mb(a) {
            return a.bAjaxDataGet
                ? (a.iDraw++, C(a, !0), sa(a, vb(a), function (b) {
                    wb(a, b)
                }), !1)
                : !0
        }
        function vb(a) {
            ...
            for (g = 0; g < c; g++) 
                ...
                t("mDataProp_" + g, i),
                d.bFilter && (t("sSearch_" + g, l.sSearch), t("bRegex_" + g, l.bRegex), t(
                    "bSearchable_" + g,
                    m.bSearchable
                )),
            ...
            l && i.append(h("<div/>", {"class": f.sScrollFoot}).css({
                ...
                width: d
                    ? !d
                        ...
                        : v(d)
                    : "100%"
            }).append(h("<div/>", {"class": f.sScrollFootInner}).append(m.removeAttr("id").css("margin-left", 0).append(
                "bottom" === j
                    ? g
                    : null
        ...
        function la(a) {
            ...
            if (a.scrollBarVis !== L && a.scrollBarVis !== k) 
                ...
                if (p.outerWidth() < f) {
                    Q = j.scrollHeight > j.offsetHeight || "scroll" == l.css("overflow-y")
                        ? f + b
                        : f;
        ...
        function Fa(a) {
            ...
            if (d || !t && !f && !e && j == V(a) && j == m.length) 
                ...
                for (n = 0; n < i.length; n++) 
                    o = c[i[n]],
                    m[n].style.width = null !== o.sWidthOrig && "" !== o.sWidthOrig
                        ? v(o.sWidthOrig)
                        : "",
                    o.sWidthOrig && f && h(m[n]).append(
        ...
        function wa(a) {
            ...
            if (e.bSort && e.bSortClasses) {
                ...
                for (f = b.length; e < f; e++) 
                    g = b[e].src,
                    h(D(a.aoData, "anCells", g)).removeClass(c + (
                        2 > e
                            ? e + 1
                            : 3
                    ));
                ...
                for (f = d.length; e < f; e++) 
                    g = d[e].src,
                    h(D(a.aoData, "anCells", g)).addClass(c + (
                        2 > e
                            ? e + 1
                            : 3
                    ))
            ...
            return e.length || d
                ? (a = new s(
                    ...
                    a
                        ? e.concat.apply([], e)
                        : e
                ), b = a.selector, b.rows = u.rows, b.cols = u.cols, b.opts = u.opts, a)
                : this
        },
    ...
    var o = new f.Api(a),
        ...
        q = function (d, f) {
            var l,
                ...
                m = function (a) {
                    a.preventDefault();
                    !b(a.currentTarget).hasClass("disabled") && o.page() != a.data.action && o
                        .page(
                            a.data.action
                        )
                        .draw("page")
