...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Approve Surat</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="../index.php" class="text-muted">Home</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Approve Surat</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table id="zero_config" class="table table-striped table-bordered display no-wrap" >
                                    ...
                                    if ($dt_user['inp_level']=="superadmin" OR $dt_user['inp_level']=="admin") {
                                        ...
                                        $ambildata  = (mysqli_query($con,"SELECT * FROM form_izin_keluar_kantor INNER JOIN nm_atasan ON nm_atasan.`inp_nip_atasan`=form_izin_keluar_kantor.`inp_nip_ketua` INNER JOIN USER ON user.`id_us`=nm_atasan.`id_user` WHERE nm_atasan.`id_user`='$id_us' ORDER BY id_izin DESC"));
                                    }
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <center>
                                                    <form action="verif_surat_kel_kantor.php?id_izin=<?php echo $data['id_izin']; ?>" method="POST">
                                                        <input type="hidden" name="appid" value="<?php echo $data['id_izin']; ?>">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-outline-danger btn-rounded" data-mdb-ripple-color="dark" data-toggle="modal" data-target="#myModal<?php echo $data['id_izin']; ?>">Tolak</button>
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-info btn-rounded" data-mdb-ripple-color="dark" data-toggle="modal" data-target="#lihat_alasan<?php echo $data['id_izin']; ?>">Lihat Alasan</button>
                                        <?php } else {
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
         ...
         <form action="tolak_izin_keluar_kantor.php" method="POST">
        <div class="modal-body">
          <tr>
              <th>Isi Alasan Disini</th>
          </tr>
          <tr>
              <td>
                  <textarea class="form-control" name="alasan_ditolak"></textarea>
                  <input type="hidden" name="id_izin" value="<?php echo $data['id_izin']; ?>">
              </td>
          </tr>
        </div>
        <div class="modal-footer">
            <input type="submit" class="btn btn-info" name="tolak" value="Tolak">
 ...
 <div class="modal fade" id="lihat_alasan<?php echo $data['id_izin']; ?>" role="dialog">
    <div class="modal-dialog">
