...
<body>
    <div id=halaman>
        ...
        <div id=halaman2>
        <div style="width: 80%; text-align: left; float: right;">Yang bertanda tangan,</div><br><br><br><br><br>
        <div style="width: 80%; text-align: left; float: right;">Arbrian Abdul Jamal</div>
    </div>
